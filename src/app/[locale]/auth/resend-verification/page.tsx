...
import { resendVerificationEmail } from '@/lib/auth/client-utils'
      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
            Haven't received your verification email? We can send it again.
          </p>
        </div>
        ...
        <div className="rounded-md bg-blue-50 dark:bg-blue-900/20 p-4">
          ...
          <ul className="text-sm text-blue-700 dark:text-blue-300 space-y-1">
            ...
            <li>• Free tier is limited to 3 emails per hour</li>
            <li>• If you've hit the limit, wait an hour before trying again</li>
            <li>• The email will come from noreply@mail.app.supabase.io</li>
          </ul>
        </div>
      </div>
    </div>
