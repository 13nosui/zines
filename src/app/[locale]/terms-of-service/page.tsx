        ...
        <div className="p-4">
          <Card className="bg-content1">
            <CardBody className="p-6 space-y-4">
              ...
              <div>
                <h3 className="text-sm font-semibold mb-1">{t('legal.acceptableUse')}</h3>
                <p className="text-sm text-default-600">
                  {t('legal.acceptableUseText')}
                </p>
              </div>
              
              <div>
                <h3 className="text-sm font-semibold mb-1">{t('legal.userContent')}</h3>
                <p className="text-sm text-default-600">
              ...
              <div>
                <h3 className="text-sm font-semibold mb-1">{t('legal.liability')}</h3>
                <p className="text-sm text-default-600">
