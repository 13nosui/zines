    ...
    it("maps known error messages to translation keys", () => {
      const errorMappings = [
        ...
        },
        {
          ...
          expected: "auth.errors.userAlreadyExists",
        },
        {
        ...
        },
        {
          ...
          expected: "auth.validation.passwordMinLength",
        },
        {
        ...
        { message: "User not found", expected: "auth.errors.userNotFound" },
        {
          ...
          expected: "auth.errors.sessionExpired",
        },
  ...
  describe("signUpWithEmail", () => {
    it("returns success data when sign up succeeds", async () => {
      ...
      expect(mockSupabase.auth.signUp).toHaveBeenCalledWith({
        ...
        options: {
          emailRedirectTo: expect.stringContaining("/auth/callback/complete"),
        },
      });
    });
  ...
  describe("signInWithOAuth", () => {
    it("initiates OAuth flow successfully", async () => {
      ...
      expect(mockSupabase.auth.signInWithOAuth).toHaveBeenCalledWith({
        provider: "google",
        options: {
          redirectTo: expect.stringContaining("/auth/callback/complete"),
          queryParams: {
            access_type: "offline",
            prompt: "consent",
          },
